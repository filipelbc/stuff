...
install-key "https://deb.nodesource.com/gpgkey/nodesource-repo.gpg.key" ${key}
add-repository "deb [signed-by=${key}] https://deb.nodesource.com/node_16.x nodistro main"
